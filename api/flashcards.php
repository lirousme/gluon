...
function buildDefaultBasePromptByStructure($deck_name, $deck_structure) {
    ...
    if ($deck_structure === 'fatos') {
        ...
        $basePrompt = 'O nome do deck "$deck_name" é sempre uma palavra ou expressão em inglês e deve aparecer em todos os cards. Gere cards para estudo de inglês seguindo rigorosamente: na frente (front), explique em português a função do termo dentro da frase de exemplo (papel gramatical, nuance de sentido e uso pragmático), sem mencionar "deck", "baralho", "neste deck" ou qualquer metacomentário; no verso (back), coloque somente uma frase em inglês, sem tradução, sem rótulo e sem texto extra. Cubra os 12 tempos verbais fundamentais do inglês (ao menos 1 frase por tempo) e gere frases adicionais para cobrir TODOS os significados e traduções relevantes do termo quando houver polissemia; portanto o total pode e deve ser maior que 12 cards nesses casos. Use muitos phrasal verbs naturais, mas também inclua usos não-phrasal do termo de forma equilibrada. Varie sujeitos, polaridade (afirmativa/negativa/interrogativa), voz e contexto. Não repita frases.';
    } else {
