...
elseif ($action === 'add_grammar_entry') {
    ...
    $allowed = [
        'nouns' => ['normal_singular_masculine_pt_br','normal_singular_masculine_en_us','normal_singular_feminine_pt_br','normal_singular_feminine_en_us','normal_plural_masculine_pt_br','normal_plural_masculine_en_us','normal_plural_feminine_pt_br','normal_plural_feminine_en_us','diminutive_singular_masculine_pt_br','diminutive_singular_masculine_en_us','diminutive_singular_feminine_pt_br','diminutive_singular_feminine_en_us','diminutive_plural_masculine_pt_br','diminutive_plural_masculine_en_us','diminutive_plural_feminine_pt_br','diminutive_plural_feminine_en_us','augmentative_singular_masculine_pt_br','augmentative_singular_masculine_en_us','augmentative_singular_feminine_pt_br','augmentative_singular_feminine_en_us','augmentative_plural_masculine_pt_br','augmentative_plural_masculine_en_us','augmentative_plural_feminine_pt_br','augmentative_plural_feminine_en_us'],
        ...
        'prepositions' => ['simple_pt_br','simple_en_us','contracted_pt_br','contracted_en_us','compound_pt_br','compound_en_us'],
