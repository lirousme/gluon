...
if (!function_exists('normalizeDeckLanguageForDirectory')) {
...
if (!function_exists('normalizeDeckStructureForDirectory')) {
...
if (!function_exists('normalizeChildDefaultType')) {
...
if (!function_exists('normalizeChildDefaultView')) {
